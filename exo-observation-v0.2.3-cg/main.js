...
async function run() {
  ...
  window.addEventListener("turboGameEvent", async (e) => {
    console.log(e.detail);
    if (e.detail.name === "midgame_ad") {
      turbo.pause();
      console.log("PAUSED");
      ...
      turbo.resume();
      console.log("RESUMED!");
    } else if (e.detail.name === "start") {
      window.CrazyGames.SDK.game.gameplayStart();
    } else if (e.detail.name === "stop") {
      window.CrazyGames.SDK.game.gameplayStop();
    } else if (e.detail.name === "happy_time") {

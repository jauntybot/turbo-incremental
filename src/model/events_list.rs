...
pub static CUTSCENES: Lazy<Vec<Dialogue>> = Lazy::new(|| vec![
    ...
    Dialogue {
        ...
        camera_pos: vec![((320, 240), 0), ((DEPOT_BOX.0 + DEPOT_BOX.2/2, DEPOT_BOX.1 - 16), 1)],
        d_box: DialogueBox::new(),
        event_broadcast: 1,
    },
    Dialogue {
        ...
        camera_pos: vec![((320, 240), 0), ((MINES_BOX.0 - 16, MINES_BOX.1 + MINES_BOX.3/2), 2)],
        d_box: DialogueBox::new(),
        event_broadcast: 2,
    },
    Dialogue {
    ...
    Dialogue {
        ...
        camera_pos: vec![((PLANT_BOX.0 + PLANT_BOX.2/2, PLANT_BOX.1 + PLANT_BOX.3/2), 0), ((COMPLEX_BOX.0 + COMPLEX_BOX.2/2, COMPLEX_BOX.1 + COMPLEX_BOX.3/2), 2), ((GATE_BOX.0 + GATE_BOX.2/2, GATE_BOX.1 - 16), 4)],
        d_box: DialogueBox::new(),
        event_broadcast: 2,
    },
]);
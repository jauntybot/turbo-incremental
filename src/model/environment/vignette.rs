...
impl Vignette {
    pub fn new() -> Self {
        Vignette {
            ...
            fade_prog: 255.,
            stage: 0,
            depot: vec![Cloud::new((320, 180), 320, 240, 0x000000), Cloud::new((DEPOT_BOX.0-16, DEPOT_BOX.1-16), 48, 0, 0x000000)],
            mines: vec![Cloud::new((320, 180), 480, 320, 0x000000),],
            clouds: vec![Cloud::new((320, 180), 780, 480, 0x000000)],
        }
    }
    ...
    pub fn handle_event(&mut self, event: &Event) {
        match event {
            ...
            Event::LateGame => {
                self.mines.clear();//fade_ranges.push((60., 120.));
            }
            _ => {}
        }
    }
